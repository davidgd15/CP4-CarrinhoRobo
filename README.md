...
```
/docs
  documentacao-chassi-robo.md
  /croqui
    vista-superior.png
    vista-inferior.png
    vista-frontal.png
    vista-lateral.png
    vista-isometrica.png
README.md
```

---

## 4. Como iniciar a documentação no GitHub

1. Crie um repositório novo no GitHub (público ou privado, conforme orientação do projeto).
2. No terminal, dentro da pasta do projeto:
   ```bash
   git init
   git add documentacao-chassi-robo.md
   git commit -m "Inicio da documentacao tecnica do chassi"
   git branch -M main
   git remote add origin https://github.com/<seu-usuario>/<nome-do-repositorio>.git
   git push -u origin main
   ```
3. Adicione este arquivo (`documentacao-chassi-robo.md`) e as imagens do croqui na pasta `/docs`.
4. Envie o link do repositório para o grupo/professor, por exemplo:
   `https://github.com/<seu-usuario>/<nome-do-repositorio>`

> Observação: como não tenho acesso à internet neste ambiente, não é possível criar o repositório remotamente por vocês — os passos acima devem ser executados por um dos integrantes com acesso ao GitHub.

---

*Documento gerado como parte da entrega de documentação técnica do projeto de robô Arduino.*
